...
var $, Compatibility, Modernizr, Pre;
...
Compatibility = (function() {
  ...
  $(document).ready(function() {
    var body, i, len, placeholder, placeholders, results;
    if (!Modernizr.srcset) {
      Pre().js('/js/picturefill-min.js');
    }
    ...
    if (!Modernizr.placeholder) {
      ...
      for (i = 0, len = placeholders.length; i < len; i++) {
        ...
        results.push((function(placeholder) {
          ...
          return placeholder.addEventListener('blur', function() {
            if (placeholder.value === '') {
              return placeholder.value = initialValue;
            }
          });
        })(placeholder));
      }
...
},{"browsernizr":10,"browsernizr/test/css/flexbox":38,"browsernizr/test/forms/placeholder":39,"browsernizr/test/img/srcset":40,"jquery":42,"pre-js":45}],2:[function(require,module,exports){
var $, Aboutwriter, Typedjs;

$ = require('jquery');

Typedjs = require('../../vendor/typed.js/typed');

Aboutwriter = (function() {
  function Aboutwriter() {
    var $topic, typedjs;
    $topic = $('.topic');
    if ($topic.length) {
      typedjs = new Typedjs($topic, {
        strings: ['music', 'design', 'photography', 'books', 'ecology', 'nature', 'meditation', 'spirituality', 'doing the right thing'],
        startDelay: 2000,
        typeSpeed: 70,
        backSpeed: 50,
        shuffle: true,
...
},{"../../vendor/typed.js/typed":9,"jquery":42}],3:[function(require,module,exports){
var $, Contactform,
...
Contactform = (function() {
  function Contactform(selector) {
    this.enableSend = bind(this.enableSend, this);
    this.disableSend = bind(this.disableSend, this);
    this.removeMessages = bind(this.removeMessages, this);
    this.addMessage = bind(this.addMessage, this);
    this.form = $(selector);
    this.sendBtns = this.form.find('[type=submit]');
    this.form.submit((function(_this) {
      return function(e) {
        var formValues;
        e.preventDefault();
        formValues = _this.form.serializeArray();
        _this.disableSend();
        _this.removeMessages();
        return $.post('http://api.thomastorfs.com/api/contact-form', $.param(formValues)).done(function(response) {
          var error, i, len, ref;
          if ((response.errors != null) && !response.errors.code) {
            ref = response.errors;
            for (i = 0, len = ref.length; i < len; i++) {
              error = ref[i];
              _this.addMessage('[name="' + error.param + '"]', 'error', error.msg);
            }
          } else if (response.success) {
            _this.addMessage('.actions', 'error', 'Your message has been succesfully sent.');
          } else {
            _this.addMessage('.actions', 'error', 'An error occurred while sending your message.');
          }
          return _this.enableSend();
  ...
  Contactform.prototype.addMessage = function(id, type, body) {
    var $msg, element;
    ...
    if (element.length) {
      ...
      $msg.hide();
      element.before($msg);
      return $msg.slideDown();
    }
  };

  Contactform.prototype.removeMessages = function() {
    var msgs;
    msgs = this.form.find('.message');
    return msgs.slideUp(function() {
      return $(this(remove()));
    });
  };

  Contactform.prototype.disableSend = function() {
    return this.sendBtns.prop('disabled', true);
  };

  Contactform.prototype.enableSend = function() {
    return this.sendBtns.prop('disabled', false);
  };
...
Navtoggler = (function() {
  function Navtoggler(selector) {
    this.attachToggle = bind(this.attachToggle, this);
    this.toggler = $(selector);
    this.body = $('body');
    this.visibleClass = 'nav--visible';
    this.hiddenClass = 'nav--hidden';
    this.attachToggle();
  }

  Navtoggler.prototype.attachToggle = function() {
    return this.toggler.click((function(_this) {
      return function(e) {
        e.preventDefault();
        _this.body.toggleClass(_this.visibleClass);
        return _this.body.toggleClass(_this.hiddenClass);
      };
    })(this));
  };
...
},{"jquery":42}],5:[function(require,module,exports){
var $, Stickyheader, throttle,
  bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; };
...
Stickyheader = (function() {
  function Stickyheader(selector) {
    this.updateHeaderClasses = bind(this.updateHeaderClasses, this);
    this.header = $(selector);
    this.w = $(window);
    this.speed = 300;
    this.lastScrollPosition = 0;
    this.minScrollPosition = 10;
    this.minHideScroll = 200;
    this.hideScrollPosition = 0;
    this.stickyClass = 'sticky';
    this.topClass = 'top';
    this.hideClass = 'hide';
    throttle(this.speed, this.w.scroll(this.updateHeaderClasses));
    this.updateHeaderClasses();
  }

  Stickyheader.prototype.updateHeaderClasses = function() {
    var scrollPosition;
    scrollPosition = this.w.scrollTop();
    if (scrollPosition > this.minScrollPosition) {
      if (!this.header.hasClass(this.stickyClass)) {
        this.header.addClass(this.stickyClass);
        this.header.removeClass(this.topClass);
      }
    } else {
      this.header.removeClass(this.stickyClass);
      this.header.addClass(this.topClass);
    }
...
},{"jquery":42,"throttle-debounce/throttle":46}],6:[function(require,module,exports){
var $, Sectionnext;
...
},{"jquery":42,"jquery.easing":41}],7:[function(require,module,exports){
var $, Aboutwriter, Compatibility, Contactform, FitVids, Navtoggler, Sectionnext, Stickheader, lazysizes, lsBgset;
...
$(document).ready(function() {
  ...
  new FitVids('body');
  return new Aboutwriter();
});


},{"./lib/Compatibility":1,"./lib/content/Aboutwriter":2,"./lib/forms/Contactform":3,"./lib/header/Navtoggler":4,"./lib/header/Stickyheader":5,"./lib/section/Sectionnext":6,"./vendor/fitvids/FitVids":8,"jquery":42,"lazysizes":43,"lazysizes/plugins/bgset/ls.bgset":44}],8:[function(require,module,exports){
var $, FitVids;

$ = require('jquery');

FitVids = (function() {
  function FitVids(wrapper, options) {
    var $wrapper, css, div, head, settings;
    this.count = 0;
    $wrapper = $(wrapper);
    settings = {
      customSelector: null,
    ...
    $wrapper.each((function(_this) {
      return function(i, el) {
        var $allVideos, ignoreList, selectors;
        ...
        return $allVideos.each(function(i, vid) {
          var $vid, aspectRatio, height, videoName, width;
          $vid = $(vid);
          ...
          return $vid.removeAttr('height').removeAttr('width');
        });
      };
    })(this));
  }
...
},{"jquery":42}],9:[function(require,module,exports){
var $, Typedjs,
  bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; };
...
Typedjs = (function() {
  function Typedjs(el, options) {
    this.defaults = bind(this.defaults, this);
    this.reset = bind(this.reset, this);
    this.shuffleArray = bind(this.shuffleArray, this);
    this.backspace = bind(this.backspace, this);
    this.typewrite = bind(this.typewrite, this);
  ...
  Typedjs.prototype.init = function() {
    var typewriteCallback;
    typewriteCallback = (function(_this) {
      return function() {
        var i, j, ref;
        for (i = j = 0, ref = _this.strings.length; 0 <= ref ? j <= ref : j >= ref; i = 0 <= ref ? ++j : --j) {
          _this.sequence[i] = i;
        }
        if (_this.shuffle) {
          _this.sequence = _this.shuffleArray(_this.sequence);
        }
        return _this.typewrite(_this.strings[_this.sequence[_this.arrayPos]], _this.strPos);
      };
    })(this);
    return this.timeout = setTimeout(typewriteCallback, this.startDelay);
  };

  Typedjs.prototype.build = function() {
    var strings;
    ...
    if (this.stringsElement) {
      ...
      strings = this.stringsElement.find('p');
      $.each(strings, (function(_this) {
        return function(key, value) {
          return _this.strings.push($(value).html());
        };
      })(this));
    }
    return this.init();
  ...
  Typedjs.prototype.typewrite = function(curString, curStrPos) {
    var humanize, typingCallback;
    if (this.stop === true) {
      return;
    }
    humanize = Math.round(Math.random() * (100 - 30)) + this.typeSpeed;
    typingCallback = (function(_this) {
      return function() {
        var charPause, curChar, endTag, pauseAfterChar, skip, substr, tag;
        charPause = 0;
        ...
        pauseAfterChar = function() {
          var backspaceCallback, nextString;
          if (curStrPos === curString.length) {
            _this.options.onStringTyped(_this.arrayPos);
            if (_this.arrayPos === _this.strings.length - 1) {
              _this.options.callback();
              _this.curLoop++;
              if (_this.loop === false || _this.curLoop === _this.loopCount) {
                return;
              }
            }
            backspaceCallback = function() {
              return _this.backspace(curString, curStrPos);
            };
            return _this.timeout = setTimeout(backspaceCallback, _this.backDelay);
          } else {
            if (curStrPos === 0) {
              _this.options.preStringTyped(_this.arrayPos);
            }
            nextString = curString.substr(0, curStrPos + 1);
            if (_this.attr) {
              _this.el.attr(_this.attr, nextString);
            } else {
              if (_this.isInput) {
                _this.el.val(nextString);
              } else if (_this.contentType === 'html') {
                _this.el.html(nextString);
              } else {
                _this.el.text(nextString);
              }
            }
            curStrPos++;
            return _this.typewrite(curString, curStrPos);
          }
        };
        return _this.timeout = setTimeout(pauseAfterChar, charPause);
      };
    })(this);
    return this.timeout = setTimeout(typingCallback, humanize);
  };

  Typedjs.prototype.backspace = function(curString, curStrPos) {
    var backspaceCallback, humanize, timeout;
    if (this.stop === true) {
      return;
    }
    humanize = Math.round(Math.random() * (100 - 30)) + this.backSpeed;
    backspaceCallback = (function(_this) {
      return function() {
        var nextString, tag;
        if (_this.contentType === 'html') {
        ...
        if (curStrPos > _this.stopNum) {
          curStrPos--;
          return _this.backspace(curString, curStrPos);
        } else if (curStrPos <= _this.stopNum) {
          _this.arrayPos++;
          if (_this.arrayPos === _this.strings.length) {
            _this.arrayPos = 0;
            if (_this.shuffle) {
              _this.sequence = _this.shuffleArray(_this.sequence);
            }
            ...
            return _this.typewrite(_this.strings[_this.sequence[_this.arrayPos]], curStrPos);
          }
        }
      };
    })(this);
    return timeout = setTimeout(backspaceCallback, humanize);
  };

  Typedjs.prototype.shuffleArray = function(array) {
    var current, tmp, top;
    tmp = null;
    current = null;
    top = array.length;
  ...
  Typedjs.prototype.reset = function() {
    var id;
    ...
    return this.options.resetCallback();
  };

  Typedjs.prototype.defaults = function() {
    var defaults;
    return defaults = {
...
},{"jquery":42}],10:[function(require,module,exports){
...
},{"./lib/Modernizr":11,"./lib/ModernizrProto":12,"./lib/classes":13,"./lib/setClasses":31,"./lib/testRunner":36}],11:[function(require,module,exports){
...
},{"./tests.js":37}],13:[function(require,module,exports){
...
},{"./computedStyle.js":14,"./domToCSS.js":21,"./injectElementWithStyles.js":24}],30:[function(require,module,exports){
...
},{"./Modernizr.js":11,"./docElement.js":19,"./isSVG.js":26}],32:[function(require,module,exports){
var ModernizrProto = require('./ModernizrProto.js');
...
},{"./ModernizrProto.js":12,"./testPropsAll.js":35}],33:[function(require,module,exports){
...
},{"./fnBind.js":22,"./is.js":25}],34:[function(require,module,exports){
...
},{"./contains.js":15,"./createElement.js":16,"./cssToDOM.js":17,"./is.js":25,"./mStyle.js":27,"./nativeTestProps.js":29}],35:[function(require,module,exports){
var ModernizrProto = require('./ModernizrProto.js');
...
},{"./ModernizrProto.js":12,"./cssomPrefixes.js":18,"./domPrefixes.js":20,"./is.js":25,"./testDOMProps.js":33,"./testProps.js":34}],36:[function(require,module,exports){
var tests = require('./tests.js');
var Modernizr = require('./Modernizr.js');
...
},{"./Modernizr.js":11,"./classes.js":13,"./is.js":25,"./tests.js":37}],37:[function(require,module,exports){
...
},{"./../../lib/Modernizr.js":11,"./../../lib/testAllProps.js":32}],39:[function(require,module,exports){
/*!
{
...
},{"./../../lib/Modernizr.js":11,"./../../lib/createElement.js":16}],40:[function(require,module,exports){
/*!
{
...
},{"./../../lib/Modernizr.js":11,"./../../lib/createElement.js":16}],41:[function(require,module,exports){
/*
